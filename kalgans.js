...
🌷 KALAU MAU RENAME TARO CREDITS GUA : XFly No Real */
...
const { hello } = require('./baseikal/hello/hello')
const { bye } = require('./baseikal/bye/bye')
...
browser: ['HW MODS WA','Safari','3.1.0'],
auth: state,
version
})
...
let link = `https://youtube.com/@xfly1065`
let buttons = [
{buttonId: `XFly No Real`, buttonText: {displayText: hello}, type: 1},
]
let buttonMessage = {
...
let link = `https://youtube.com/@xfly1065`
let buttons = [
{buttonId: `XFly No Real`, buttonText: {displayText: bye}, type: 1},
]
let buttonMessage = {
document: fs.readFileSync('./baseikal/lib/tes.xlsx'),
mimetype: feler,
